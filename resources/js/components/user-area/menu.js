        ...
        if(pageRoute===true){
            menu.push(
                <ul className="menu-area">
                    ...
                    <li><a href="/participacoes-user"><i className="fas fa-briefcase" aria-hidden="true"/> Participação Social</a></li>
                    <li><a href="/projetos-user"><i className="fas fa-briefcase" aria-hidden="true"/> Projetos</a></li>
                    <li><a href="/recursos-user"><i className="fas fa-briefcase" aria-hidden="true"/> Fontes de recursos</a></li>
                </ul>
            );
        }
        return menu;
