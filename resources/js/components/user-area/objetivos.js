                                ...
                                <div className="col-md-12">
                                    ...
                                    <div style={{display: this.state.titleMeta ? '' : 'none'}}>
                                        ...
                                        <div>
                                            ...
                                            />
                                            {/*/=============================*/}
                                            <div style={{display: this.state.maxObjetivosExist===false &&  this.state.maxObjetivos >= 3 ? 'none' : ''}}>
                                                {metas}
                                            </div>
                                            <div className="alert alert-info"  style={{display: this.state.maxObjetivosExist===true &&  this.state.maxObjetivos >= 3 ? 'none' : ''}}>
