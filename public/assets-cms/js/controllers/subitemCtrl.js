cmsApp.controller('subitemCtrl', ['$scope', '$http', 'Upload', '$timeout', function($scope, $http, Upload, $timeout){
    ...
    $scope.$watch('subitem.item_id', function(){
        listarSubitems();
    });

    var listarSubitems = function(){
        $scope.processandoListagem = true;
        $http({
            url: 'cms/listar-subitems',
            method: 'GET',
            params: {
    ...
    $scope.inserir = function (file, arquivo){
        ...
        if(file==null && arquivo==null){
            ...
            $http.post("cms/inserir-subitem", {subitem: $scope.subitem}).success(function (data){
                 listarSubitems();
                //delete $scope.subitem;//limpa o form
                //deleta um por um para não excluir o id da tabela relacionada
                $scope.subitem.titulo = '';
                $scope.subitem.descricao = '';
                $scope.subitem.posicao = '';
            ...
            Upload.upload({
                url: 'cms/inserir-subitem',
                data: {subitem: $scope.subitem, file: file, arquivo: arquivo},
    ...
    $scope.positionDown = function(id){
        ...
        $http({
            url: 'cms/positionDown-subitem/'+id,
            method: 'GET'
