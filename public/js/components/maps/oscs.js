            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(BarChart, { id: 'bar-chart1', data: this.state.oscs, colors: this.state.colorsChart })
                    ),
                    React.createElement(
                        'div',
                        ...
                        React.createElement(
                            ...
                            React.createElement(PieChart, { id: 'pie-chart1', data: this.state.oscs })
                        )
                    )
                ),
                React.createElement('br', null),
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'div',
                        { className: 'col-md-6 col-sm-12' },
                        React.createElement(BarChart, { id: 'bar-chart2', data: this.state.oscsGeral, colors: this.state.colorsChart })
                    ),
                    React.createElement(
                        'div',
                        { className: 'col-md-6 col-sm-12 text-center' },
                        React.createElement(
                            'div',
                            { style: { margin: '50px auto' } },
                            React.createElement(PieChart, { id: 'pie-chart2', data: this.state.oscsGeral })
                        )
                    )
                )
            ),
