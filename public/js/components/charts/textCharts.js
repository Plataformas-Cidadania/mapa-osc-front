...
var TextCharts = (function (_React$Component) {
    _inherits(TextCharts, _React$Component);

    function TextCharts(props) {
        _classCallCheck(this, TextCharts);

        _get(Object.getPrototypeOf(TextCharts.prototype), 'constructor', this).call(this, props);
        this.state = {
            mychart: null,
            loading: false,
            yaxis: [],
    ...
    _createClass(TextCharts, [{
        ...
        value: function componentWillReceiveProps(props) {
            ...
            var areas = ['area_atuacao', 'Área de Atuação', 'pie'];
            //let areas = ['area_atuacao', 'evolucao_quantidade_osc_ano', 'natureza_juridica', 'orcamento', 'repasse_recursos', 'trabalhadores'];
            ...
            for (var chart in data) {
                ...
                var dataChart = data[chart].area_atuacao.series_1;

                var labels = [];
                var series = [];
                var _name = data[chart].area_atuacao.tx_porcentagem_maior;
                var fontes = data[chart].fontes ? data[chart].fontes.join(', ') : "";
                ...
                /*let tipoGrafico =
                    data[chart].tipo_grafico === "MultiBarChart" || data[chart].tipo_grafico === "BarChart" ? "column" :
