...
var PreRegister = (function (_React$Component) {
    _inherits(PreRegister, _React$Component);

    function PreRegister(props) {
        _classCallCheck(this, PreRegister);

        _get(Object.getPrototypeOf(PreRegister.prototype), "constructor", this).call(this, props);
        this.state = {};
    }

    _createClass(PreRegister, [{
        key: "render",
