  ...
  render() {
    ...
    let firstCategories = this.state.categories.map(function (item, index) {
      if (index < showQtdItems) {
        ...
        }, /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement("u", null, firstPiece), lastPiece), /*#__PURE__*/React.createElement("span", {
