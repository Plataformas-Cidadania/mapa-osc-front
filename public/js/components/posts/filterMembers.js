class MembersFilter extends React.Component {
  ...
  render() {
    ...
    let firstMembers = this.state.members.map(function (item, index) {
      if (index < showQtdItems) {
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          src: "imagens/integrantes/" + item.imagem,
          alt: "",
          className: "rounded-circle float-left",
          width: "40"
        }), /*#__PURE__*/React.createElement("h4", null, /*#__PURE__*/React.createElement("u", null, firstPiece), lastPiece, /*#__PURE__*/React.createElement("span", {
          className: "badge badge-primary badge-pill float-right",
          style: {
            margin: '8px 20px 0 0'
          }
        }, qtd)), /*#__PURE__*/React.createElement("hr", null));
      }
    }.bind(this));
      ...
      if (index >= showQtdItems) {
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          style: {
            cursor: 'pointer',
            color: color,
            display: this.state.showOtherItems ? '' : 'none'
          },
          onClick: () => this.addMember(item)
        }, /*#__PURE__*/React.createElement("img", {
          src: "imagens/integrantes/" + item.imagem,
          ...
          className: "rounded-circle float-left",
          width: "40"
        }), /*#__PURE__*/React.createElement("h4", null, /*#__PURE__*/React.createElement("u", null, firstPiece), lastPiece, " - ", qtd), /*#__PURE__*/React.createElement("hr", null));
      }
    }.bind(this));
    let membersSelected = this.state.membersSelected.map(function (item) {
      return /*#__PURE__*/React.createElement("button", {
        key: "btn_member_" + item.id,
        id: item.id,
        onClick: this.removeMember,
        type: "button",
        className: "btn btn-success btn-xs btn-remove",
        style: {
          margin: "0 5px 5px 0"
        }
      }, item.titulo, " ", /*#__PURE__*/React.createElement("i", {
    ...
    }, "Mais ", qtdItems - showQtdItems, " ", /*#__PURE__*/React.createElement("i", {
    ...
    }, "Menos ", qtdItems - showQtdItems, " ", /*#__PURE__*/React.createElement("i", {
