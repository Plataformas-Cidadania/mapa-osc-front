  ...
  load() {
    $.ajax({
      ...
      success: function (data) {
        ...
        this.setState({
          archives: data,
          archivesSelected: archivesSelected,
          loading: false
        });
  ...
  render() {
    ...
    let firstArchives = this.state.archives.map(function (item, index) {
      if (index < showQtdItems) {
        ...
        }, month, " de ", year, /*#__PURE__*/React.createElement("span", {
    ...
    let archivesSelected = this.state.archivesSelected.map(function (item, index) {
      ...
      }, item.month, " de ", item.year, " ", /*#__PURE__*/React.createElement("i", {
        className: "fas fa-times"
      }));
    }.bind(this));
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", null, archivesSelected), /*#__PURE__*/React.createElement("ul", {
      className: "list-group",
      style: {
        clear: 'both'
      }
    }, firstArchives, otherArchives), /*#__PURE__*/React.createElement("div", {
      style: {
