  ...
  render() {
    let menu = this.state.menu.map(function (item) {
      return /*#__PURE__*/React.createElement("li", {
        ...
        className: item.id === 1 ? 'fas fa-landmark' : 'fas fa-map-marker-alt',
        "aria-hidden": "true"
      }), item.title);
    }.bind(this));
    let menuList = [];
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "col-md-5 search-home"
    }, /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("h2", {
      className: "text-center"
    }, "Busque uma OSC no Mapa"), /*#__PURE__*/React.createElement("p", {
      className: "search-home-subtitle"
    }, "Encontre organiza", "\u00e7\u00f5es", " da sociedade civil em todo o Brasil"), /*#__PURE__*/React.createElement("div", {
      ...
      type: "text",
      id: "searchInput",
      value: this.state.searchOsc,
      placeholder: this.state.searchOscTxt,
      onChange: this.handleSearchOsc
    }), this.state.searchOsc ? /*#__PURE__*/React.createElement("button", {
      type: "button",
      ...
      onClick: () => this.state.searchOsc.trim() ? this.startAdvancedSearch(this.state.searchOsc.trim()) : null
    }, /*#__PURE__*/React.createElement("i", {
      ...
      className: "advanced-search-action",
      href: "filtro"
    }, /*#__PURE__*/React.createElement("i", {
      className: "fas fa-sliders-h",
      "aria-hidden": "true"
    }), "Utilize a Consulta Avan", "\u00e7", "ada", /*#__PURE__*/React.createElement("i", {
