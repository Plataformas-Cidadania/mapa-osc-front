    ...
    render() {
        ...
        if (this.state.areaAtuacao) {
            areaAtuacao = this.state.areaAtuacao.map(function (item) {
                ...
                return React.createElement(
                    'div',
                    { className: 'custom-control custom-checkbox', key: "area_" + item.cd_area_atuacao, onChange: () => {
        ...
        return React.createElement(
            ...
            React.createElement(
                'form',
                { id: 'frmMapa', name: 'frmMapa', action: 'mapa-busca-avancada', method: 'POST', onKeypress: this.handleKeyPress },
