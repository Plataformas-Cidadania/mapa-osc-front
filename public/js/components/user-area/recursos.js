...
var Recursos = (function (_React$Component) {
    _inherits(Recursos, _React$Component);

    function Recursos(props) {
        _classCallCheck(this, Recursos);

        _get(Object.getPrototypeOf(Recursos.prototype), 'constructor', this).call(this, props);
        this.state = {
            anosRecursos: [],
            dataRecursos: [],
            dataSemRecursos: [],
    ...
    _createClass(Recursos, [{
        key: 'desativarTour',
        value: function desativarTour(acao) {
        ...
        value: function getAnos(acao) {
            ...
            $.ajax({
                ...
                success: (function (data) {
                    ...
                    var data2 = data;
                    var campoAno = this.state.campoAno;

                    var dataAntes = data.length;
                    ...
                    var dataDepois = data.length;
                    var activeIncert = dataAntes !== dataDepois;
        ...
        key: 'callTour',
        value: function callTour() {
            this.setState({ loading: false });
        }
    }, {
        key: 'callPushAnos',
        value: function callPushAnos() {
            this.callAddAnos(false);
            this.getAnos(true);
        }
    }, {
        key: 'callRecursos',
        value: function callRecursos(ano) {
            $.ajax({
                method: 'GET',
                cache: false,
        ...
        key: 'callAddAnos',
        value: function callAddAnos(acao) {
            var activeMsg = false;
        ...
        key: 'callRecursosValue',
        value: function callRecursosValue() {
            ...
            if (this.state.dataRecursos) {
                if (this.state.dataRecursos[1] !== undefined) {
                    for (var i in this.state.dataRecursos[1]) {
                ...
                if (this.state.dataRecursos[2] !== undefined) {
                    for (var i in this.state.dataRecursos[2]) {
                ...
                if (this.state.dataRecursos[3] !== undefined) {
                    for (var i in this.state.dataRecursos[3]) {
                ...
                if (this.state.dataRecursos[4] !== undefined) {
                    for (var i in this.state.dataRecursos[4]) {
        ...
        value: function getSemRecursos() {
            $.ajax({
                ...
                success: (function (data) {
                    /*/////////////////////////////////////*/
                    var recursos_publicos = {
                        origem: {
                            cd_origem_fonte_recursos_osc: 0
                        }
                    };

                    var recursos_privados = {
                        origem: {
                            cd_origem_fonte_recursos_osc: 0
                        }
                    };

                    var recursos_financeiros = {
                        origem: {
                            cd_origem_fonte_recursos_osc: 0
                        }
                    };

                    var recursos_proprios = {
                        origem: {
                            cd_origem_fonte_recursos_osc: 0
                        }
                    };
                    ...
                    if (data[this.state.ano] !== undefined) {
                        if (data[this.state.ano].length > 0) {
                            for (var i in data[this.state.ano]) {
                    ...
                    var item_recursos_publicos = recursos_publicos.origem.cd_origem_fonte_recursos_osc === 1 ? true : false;
                    var item_recursos_privados = recursos_privados.origem.cd_origem_fonte_recursos_osc === 2 ? true : false;
                    var item_recursos_financeiros = recursos_financeiros.origem.cd_origem_fonte_recursos_osc === 3 ? true : false;
                    var item_recursos_proprios = recursos_proprios.origem.cd_origem_fonte_recursos_osc === 4 ? true : false;
        ...
        key: 'addSemRecursos',
        value: function addSemRecursos(cd_origem, status) {

            var item_recursos_publicos = !this.state.item_recursos_publicos;
            var item_recursos_privados = !this.state.item_recursos_privados;
            var item_recursos_financeiros = !this.state.item_recursos_financeiros;
            var item_recursos_proprios = !this.state.item_recursos_proprios;
                ...
                anosRecursos = this.state.anosRecursos.map((function (item, index) {
                    ...
                    return React.createElement(
                        ...
                        { key: "anos_" + index, id: "anos_" + index,
                            onClick: function () {
                                return _this.callRecursos(item);
                            },
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(
                                        ...
                                        React.createElement(
                                            ...
                                            React.createElement(
                                                ...
                                                React.createElement(
                                                    'a',
                                                    { onClick: function () {
                                                            return _this2.callAddAnos(false);
                                                        }, style: { display: this.state.addAnos ? "" : "none" }, className: 'text-danger cursor' },
                                        ...
                                        React.createElement(
                                            'a',
                                            { className: 'cursor', onClick: function () {
                                                    return _this2.callAddAnos(true);
                                                }, style: { display: this.state.addAnos ? "none" : "", top: '4px', position: 'relative' } },
                                        ...
                                        React.createElement(
                                            ...
                                            React.createElement(
                                                ...
                                                'Para adicionar mais um ano, será preciso informar uma contribuição pertinente ao ano! ',
                                                React.createElement('br', null),
                                                React.createElement('br', null),
                                                React.createElement(
                                                    'a',
                                        ...
                                        React.createElement(
                                            ...
                                            React.createElement(
                                                ...
                                                React.createElement(
                                                    'div',
                                                    { className: 'cursor', onClick: function () {
                                                            return _this2.addSemRecursos(1, !_this2.state.item_recursos_publicos);
                                                        } },
                                                    React.createElement(
                                                        'div',
                                        ...
                                        React.createElement(
                                            ...
                                            React.createElement(
                                                ...
                                                React.createElement(
                                                    'div',
                                                    { className: 'cursor', onClick: function () {
                                                            return _this2.addSemRecursos(2, !_this2.state.item_recursos_privados);
                                                        } },
                                                    React.createElement(
                                                        'div',
                                                        { className: 'float-left', style: { display: this.state.loadingNPossui ? '' : 'none' } },
                                        ...
                                        React.createElement(
                                            ...
                                            React.createElement(
                                                ...
                                                React.createElement(
                                                    'div',
                                                    { className: 'cursor', onClick: function () {
                                                            return _this2.addSemRecursos(3, !_this2.state.item_recursos_financeiros);
                                                        } },
                                                    React.createElement(
                                                        'div',
                                                        { className: 'float-left', style: { display: this.state.loadingNPossui ? '' : 'none' } },
                                        ...
                                        React.createElement(
                                            ...
                                            React.createElement(
                                                ...
                                                React.createElement(
                                                    'div',
                                                    { className: 'cursor', onClick: function () {
                                                            return _this2.addSemRecursos(4, !_this2.state.item_recursos_proprios);
                                                        } },
                                                    React.createElement(
                                                        'div',
                                                        { className: 'float-left', style: { display: this.state.loadingNPossui ? '' : 'none' } },
...
/*=============================*/ /*=============================*/ /*=============================*/ /*=============================*/ /*////////////////////////////PUBLICOS//////////////////////////////*/ /*=============================*/ /*=============================*/ /*/////////////////////*/ /*=============================*/ /*/=============================*/ /*/////////////////////*/ /*////////////////////////////PRIVADOS//////////////////////////////*/ /*/////////////////////*/ /*/////////////////////*/ /*////////////////////////////NAO FINANCEIROS//////////////////////////////*/ /*/////////////////////*/ /*/////////////////////*/ /*////////////////////////////PROPRIOS//////////////////////////////*/ /*/////////////////////*/ /*/////////////////////*/