class Certificates extends React.Component {
  ...
  getOscData() {
    $.ajax({
      ...
      success: function (data) {
        this.setState({
          bo_nao_possui_certificacoes: data.bo_nao_possui_certificacoes || false
        });
      }.bind(this),
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
      ...
      id: "checkCertificacoes",
      checked: this.state.bo_nao_possui_certificacoes,
      onChange: this.handleCheckCertificacoes
    }), /*#__PURE__*/React.createElement("label", {
      className: "custom-control-label",
      htmlFor: "checkCertificacoes"
    }, "N\xE3o possui t\xEDtulos ou certificados")), !this.state.bo_nao_possui_certificacoes && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
      style: {
