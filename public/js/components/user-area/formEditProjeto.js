...
var FormEditProjeto = (function (_React$Component) {
    _inherits(FormEditProjeto, _React$Component);

    function FormEditProjeto(props) {
        _classCallCheck(this, FormEditProjeto);

        _get(Object.getPrototypeOf(FormEditProjeto.prototype), 'constructor', this).call(this, props);
        this.state = {
            form: {
                dt_inicio_projeto: '',
                dt_fim_projeto: '',
        ...
        value: function listObjetivos() {
            ...
            $.ajax({
                ...
                success: (function (data) {
                    ...
                    var arrUnique = [].concat(_toConsumableArray(new Set(objetosSelected)));
        ...
        value: function render() {
            ...
            if (this.state.datalistFinanciadores) {
                financiador_projeto = this.state.datalistFinanciadores.map((function (item, index) {
                    ...
                    return React.createElement(
                        ...
                        React.createElement('input', { className: "form-control form-g ", type: 'text', name: 'tx_nome_financiador',
            ...
            if (this.state.datalistPublicos) {
                publico_projeto = this.state.datalistPublicos.map((function (item, index) {
                    ...
                    return React.createElement(
                        ...
                        React.createElement('input', { className: "form-control form-g ", type: 'text', name: 'tx_nome_publico_beneficiado',
                            onChange: this.handleInputChange,
                ...
                localizacao_projeto = this.state.datalistLocalizacoes.map((function (item, index) {
                    ...
                    return React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement('input', { className: "form-control form-g ", type: 'text',
            ...
            if (this.state.datalistParcerias) {
                parceira_projeto = this.state.datalistParcerias.map((function (item, index) {
                    ...
                    return React.createElement(
                        ...
                        React.createElement('input', { className: "form-control form-g ", type: 'text', name: 'tx_nome_fantasia_osc',
                            onChange: this.handleInputChange,
            ...
            if (this.state.objetivos) {
                objetivos = this.state.objetivos.map((function (item) {
                            ...
                            return React.createElement(
                                ...
                                React.createElement(
                                    ...
                                    { className: 'custom-control custom-checkbox',
                                        onChange: function () {
                                            return _this5.checkMetas(item.cd_objetivo_projeto, itemMeta.cd_meta_projeto, id_objetivo_projeto, !checkedMeta2);
                                        } },
                                    React.createElement('input', { type: 'checkbox', className: 'custom-control-input',
                                        id: "subarea_" + itemMeta.cd_meta_projeto, required: true,
                    ...
                    return React.createElement(
                        'div',
                        { className: 'custom-control custom-checkbox', key: "area_" + item.cd_objetivo_projeto,
                            onChange: function () {
                                return _this6.callSubobjetivos(item.cd_objetivo_projeto);
                            }, style: { paddingLeft: 0 } },
                        React.createElement('input', { type: 'checkbox', className: 'custom-control-input', id: "area_" + item.cd_objetivo_projeto,
                            required: true }),
                        React.createElement(
                            'label',
                            { htmlFor: "area_" + item.cd_objetivo_projeto,
                                style: { marginLeft: '0', marginRight: '5px', paddingBottom: 0 } },
                            React.createElement('img', { src: "img/ods/" + png + ".png", alt: '',
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(
                                        'div',
                                        { className: 'label-float' },
                                        React.createElement('input', { className: "form-control form-g ", type: 'text', name: 'tx_nome_projeto',
                                            onChange: this.handleInputChange,
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(
                                        'div',
                                        { className: 'label-float' },
                                        React.createElement('input', { className: "form-control form-g ", type: 'date',
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(
                                        'div',
                                        { className: 'label-float' },
                                        React.createElement('input', { className: "form-control form-g ", type: 'date', name: 'dt_data_fim_projeto',
                                            onChange: this.handleInputChange,
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(
                                        'div',
                                        { className: 'label-float' },
                                        React.createElement('input', { className: "form-control form-g ", type: 'text', name: 'tx_link_projeto',
                                            onChange: this.handleInputChange,
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(
                                        'div',
                                        { style: { display: this.state.showMsg ? 'block' : 'none' },
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(
                                        ...
                                        React.createElement('input', { type: 'checkbox', className: 'custom-control-input', id: "tp_termo_fomento",
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(
                                        ...
                                        React.createElement('input', { type: 'checkbox', className: 'custom-control-input', id: "tp_termo_parceria",
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(
                                        ...
                                        React.createElement('input', { type: 'checkbox', className: 'custom-control-input', id: "tp_convenio",
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(
                                        ...
                                        React.createElement('input', { type: 'checkbox', className: 'custom-control-input', id: "tp_outro",
   ...
   <div style={{display: this.state.saveLoading==='localizacao_'+item.id_localizacao_projeto ? '' : 'none'}}><i className="fa fa-spin fa-spinner"/></div>
         ...
         />*/ /*<div className="float-right" onClick={() => this.saveList('parceira', item.id_osc_parceira_projeto)}  style={{margin: '0 10px'}}>
                 ...
                 <div style={{display: this.state.saveLoading==='parceira_'+item.id_osc_parceira_projeto ? '' : 'none'}}><i className="fa fa-spin fa-spinner"/></div>
                       ...
                       dangerouslySetInnerHTML={{__html: iconType(this.state.form.ft_nome_projeto)}}/>*/ /*<option value="1">Arquivado, cancelado ou indeferido</option>
                                                                                                         <option value="3">Proposta</option>
                                                                                                         <option value="4">Projeto em andamento</option>
                                                                                                         <option value="2">Finalizado</option>
                                                                                                         <option value="5">Outro</option>*/ /*<label htmlFor="cd_certificado">Abrangência de atuação*</label><br/>*/ /*Fontes recursos*/ /* ******************************** */ /*Fontes recursos*/ /*//////////////////////Financiadores//////////////////////*/ /*//////////////////////Financiadores//////////////////////*/ /*//////////////////////Financiadores//////////////////////*/ /*//////////////////////Financiadores//////////////////////*/ /*//////////////////////Local de execução//////////////////////*/ /*//////////////////////Local de execução//////////////////////*/ /*//////////////////////Financiadores//////////////////////*/ /*//////////////////////Financiadores//////////////////////*/