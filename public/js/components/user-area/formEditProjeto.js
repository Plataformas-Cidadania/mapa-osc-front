    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (data.nr_valor_total_projeto) {
          data.nr_valor_total_projeto = parseFloat(data.nr_valor_total_projeto).toLocaleString('pt-BR', {
            minimumFractionDigits: 2,
            maximumFractionDigits: 2
          });
        }
        if (data.nr_valor_captado_projeto) {
          data.nr_valor_captado_projeto = parseFloat(data.nr_valor_captado_projeto).toLocaleString('pt-BR', {
            minimumFractionDigits: 2,
            maximumFractionDigits: 2
          });
        }
