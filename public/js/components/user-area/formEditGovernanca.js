...
var FormEditGovernanca = (function (_React$Component) {
    _inherits(FormEditGovernanca, _React$Component);

    function FormEditGovernanca(props) {
        _classCallCheck(this, FormEditGovernanca);

        _get(Object.getPrototypeOf(FormEditGovernanca.prototype), 'constructor', this).call(this, props);
        this.state = {
            form: {
                tx_nome_dirigente: '',
                tx_cargo_dirigente: ''
    ...
    _createClass(FormEditGovernanca, [{
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            'Máximo de Governancaz Cadastrados'
                        )
                    )
                )
            );
