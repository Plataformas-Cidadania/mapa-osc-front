...
var FormEditConselho = (function (_React$Component) {
    _inherits(FormEditConselho, _React$Component);

    function FormEditConselho(props) {
        _classCallCheck(this, FormEditConselho);

        _get(Object.getPrototypeOf(FormEditConselho.prototype), 'constructor', this).call(this, props);
        this.state = {
            form: {
                tx_nome_conselheiro: ''
            },
