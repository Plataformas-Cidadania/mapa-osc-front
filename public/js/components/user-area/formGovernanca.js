...
var FormGovernanca = (function (_React$Component) {
    _inherits(FormGovernanca, _React$Component);

    function FormGovernanca(props) {
        _classCallCheck(this, FormGovernanca);

        _get(Object.getPrototypeOf(FormGovernanca.prototype), 'constructor', this).call(this, props);
        this.state = {
            form: {
                tx_nome_dirigente: '',
                tx_cargo_dirigente: ''
