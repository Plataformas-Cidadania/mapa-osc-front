class FormEditParticipacaoConselho extends React.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      value: this.state.form.cd_conselho
      ...
      className: "form-control ",
      name: "cd_periodicidade_reuniao_conselho",
      onChange: this.handleInputChange,
      value: this.state.form.cd_periodicidade_reuniao_conselho
    }, /*#__PURE__*/React.createElement("option", {
      value: "0"
      ...
      onChange: this.handleInputChange,
      defaultValue: this.state.form.dt_data_inicio_conselho,
      ...
      onChange: this.handleInputChange,
      defaultValue: this.state.form.dt_data_fim_conselho,
      placeholder: "Se houver, insira o link que"
    }), /*#__PURE__*/React.createElement("label", {
