  ...
  listCnae() {
    ...
    $.ajax({
      ...
      success: function (data) {
        this.setState({
          loading: false,
          dataCnae: data.tx_nome_atividade_economica_osc
        });
      }.bind(this),
      error: function (xhr, status, err) {
        console.error(status, err.toString());
  ...
  listCnaeArea() {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        this.setState({
          loading: false,
          dataCnaeArea: dataArea,
          dataCnaeSubArea: data
        });
      }.bind(this),
      error: function (xhr, status, err) {
        console.error(status, err.toString());
  ...
  render() {
    ...
    if (this.state.areaAtuacao) {
      areaAtuacao = this.state.areaAtuacao.map(function (item) {
        ...
        if (item.subareas) {
          subarea = item.subareas.map(function (subitem) {
            ...
            return /*#__PURE__*/React.createElement("div", {
              ...
              onChange: () => this.checkSubArea(item.cd_area_atuacao, subitem.cd_subarea_atuacao, subitem.checkedSubarea, subitem.idSelectedSub)
            }, /*#__PURE__*/React.createElement("input", {
              type: "checkbox",
              className: "custom-control-input",
              id: "subarea_" + subitem.cd_subarea_atuacao,
              required: true,
              defaultChecked: subitem.checkedSubarea
        ...
        subareaAtuacao.push(/*#__PURE__*/React.createElement("div", {
          ...
          className: "card",
          style: {
            display: item.checkedAtuacaoArea ? '' : 'none'
          }
        }, /*#__PURE__*/React.createElement("div", {
          className: "bg-lgt p-2"
        }, /*#__PURE__*/React.createElement("strong", null, /*#__PURE__*/React.createElement("i", {
          className: this.state.icons[item.cd_area_atuacao] + " fa-1x"
        }), " ", item.tx_nome_area_atuacao), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("hr", null), subarea, /*#__PURE__*/React.createElement("div", {
          style: {
            display: this.checkedOutros(item.cd_area_atuacao) ? '' : 'none'
          }
        }, /*#__PURE__*/React.createElement("input", {
          ...
          defaultValue: item.tx_nome_outra
        }), /*#__PURE__*/React.createElement("div", {
          className: "float-right",
          onClick: () => this.saveOutrosSub(item.idSelectedSub),
          style: {
            margin: '-30px 10px 0 0'
          }
        }, /*#__PURE__*/React.createElement("div", {
          style: {
            display: this.state.saveLoading === item.idSelectedSub ? 'none' : ''
          }
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          type: "checkbox",
          className: "custom-control-input",
          onChange: this.callSubareaAtuacao,
          id: "area_" + item.cd_area_atuacao,
          required: true,
          checked: item.checkedAtuacaoArea
        }), /*#__PURE__*/React.createElement("label", {
          className: "custom-control-label",
          htmlFor: "area_" + item.cd_area_atuacao
        }, /*#__PURE__*/React.createElement("i", {
          className: this.state.icons[item.cd_area_atuacao] + " fa-2x"
        }), /*#__PURE__*/React.createElement("p", null, item.tx_nome_area_atuacao)))), /*#__PURE__*/React.createElement("br", null));
      }.bind(this));
    }
    ...
    if (this.state.dataCnaeSubArea) {
      areaAtuacaoCnae = this.state.dataCnaeSubArea.map(function (item) {
        ...
        return /*#__PURE__*/React.createElement("div", {
          key: "area_" + item.cd_area_atuacao
        }, /*#__PURE__*/React.createElement("strong", null, "Sub\xE1rea: "), teste);
      }.bind(this));
    }
    /////////////////////////////////////////
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      "aria-hidden": "true"
    })), /*#__PURE__*/React.createElement("h3", null, "\xC1reas e Sub\xE1reas de atua\xE7\xE3o da OSC"), /*#__PURE__*/React.createElement("hr", null), /*#__PURE__*/React.createElement("br", null)), /*#__PURE__*/React.createElement("div", {
      className: "form-row"
    }, /*#__PURE__*/React.createElement("div", {
    ...
    }, this.state.tooltip)), /*#__PURE__*/React.createElement("strong", null, "Atividade econ\xF4mica (CNAE): "), " ", this.state.dataCnae, " ", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("strong", null, "\xC1rea de Atua\xE7\xE3o: ", this.state.dataCnaeArea), areaAtuacaoCnae))), /*#__PURE__*/React.createElement("br", null)), /*#__PURE__*/React.createElement("div", {
      className: "row"
    }, /*#__PURE__*/React.createElement("div", {
      className: "col-md-12"
    }, /*#__PURE__*/React.createElement("div", {
      className: "col-md-12"
    }, /*#__PURE__*/React.createElement("strong", null, "\xC1rea de Atua\xE7\xE3o"), /*#__PURE__*/React.createElement("hr", null), /*#__PURE__*/React.createElement("div", {
      className: "row"
    }, /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        position: 'fixed',
        zIndex: '999',
        display: this.state.boxInfo ? '' : 'none'
      }
    }, "\xC9 preciso excluir as Sub\xE1rea de Atua\xE7\xE3o, para desativar uma \xE1rea!  ", /*#__PURE__*/React.createElement("button", {
      className: "btn btn-danger",
      onClick: this.callSubareaAtuacao
    }, "X")), areaAtuacao, /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("div", {
      className: "col-md-12",
      style: {
        display: this.state.imputOutros ? '' : 'none'
      }
    }, /*#__PURE__*/React.createElement("input", {
      className: "form-control form-g ",
      type: "text",
      ...
      style: {
        display: this.state.dataAtuacaoBd.length > 0 ? 'none' : ''
      }
    }, "Selecione uma \xE1rea e sub\xE1rea de atua\xE7\xE3o!"), /*#__PURE__*/React.createElement("strong", null, "Sub\xE1rea de Atua\xE7\xE3o"), /*#__PURE__*/React.createElement("hr", null), /*#__PURE__*/React.createElement("div", {
      className: "card-columns"
    }, subareaAtuacao))))));
  }
}
ReactDOM.render(/*#__PURE__*/React.createElement(Atuacoes, {
  id: id
