...
var FormEditParticipacaoConferencia = (function (_React$Component) {
    _inherits(FormEditParticipacaoConferencia, _React$Component);

    function FormEditParticipacaoConferencia(props) {
        _classCallCheck(this, FormEditParticipacaoConferencia);

        _get(Object.getPrototypeOf(FormEditParticipacaoConferencia.prototype), 'constructor', this).call(this, props);
        this.state = {
            form: {
                cd_conferencia: '',
                dt_ano_realizacao: '',
    ...
    _createClass(FormEditParticipacaoConferencia, [{
        ...
        key: 'editConferencia',
        value: function editConferencia() {
            $.ajax({
                method: 'GET',
    ...
    return FormEditParticipacaoConferencia;
})(React.Component);