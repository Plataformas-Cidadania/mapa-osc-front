...
var Objetivos = (function (_React$Component) {
    _inherits(Objetivos, _React$Component);

    function Objetivos(props) {
        _classCallCheck(this, Objetivos);

        _get(Object.getPrototypeOf(Objetivos.prototype), "constructor", this).call(this, props);
        this.state = {
            showIcon: false,
            objetivos: [],
            subobjetivos: null,
    ...
    _createClass(Objetivos, [{
        ...
        key: "checkMetas",
        value: function checkMetas(cd_objetivo, cd_meta, id_objetivo_osc, checkedMeta) {
                ...
                objetivos = this.state.objetivos.map((function (item) {
                            ...
                            return React.createElement(
                                ...
                                React.createElement(
                                    ...
                                    { className: "custom-control custom-checkbox", onChange: function () {
                                            return _this.checkMetas(item.cd_objetivo_projeto, itemMeta.cd_meta_projeto, id_objetivo_osc, !checkedMeta2);
                                        } },
                    ...
                    return React.createElement(
                        ...
                        { className: "custom-control custom-checkbox", key: "area_" + item.cd_objetivo_projeto, onChange: function () {
                                return _this2.callSubobjetivos(item.cd_objetivo_projeto);
                            }, style: { paddingLeft: 0 } },
                                        ...
                                        React.createElement(
                                            ...
                                            React.createElement(
                                                ...
                                                React.createElement(
                                                    "p",
                                                    null,
                                                    "Você atingiu a quantidade máxima de objetivos permitidos (3)! "
                                                )
                                            )
                                        )
                                    )
