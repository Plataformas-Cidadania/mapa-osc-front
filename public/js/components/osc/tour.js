class Tour extends React.Component {
  ...
  render() {
    return /*#__PURE__*/React.createElement("div", {
      className: "bg-pri box-help  " + this.state.float,
      style: {
        top: this.props.top,
        display: this.props.display ? '' : 'none'
      }
    }, /*#__PURE__*/React.createElement("strong", null, this.state.passo, "\xBA Passo"), /*#__PURE__*/React.createElement("p", null, this.state.txt), /*#__PURE__*/React.createElement("div", {
      className: "box-help-btns"
    }, /*#__PURE__*/React.createElement("a", {
      className: "btn btn-outline-light btn-outline-light-hover float-right",
      style: {
        margin: '0 10px',
        display: this.props.position !== 1 ? '' : 'none'
      },
      onClick: () => this.callPassos(this.state.passo)
    }, "Pr\xF3ximo passo"), /*#__PURE__*/React.createElement("a", {
      className: "btn btn-outline-light btn-outline-light-hover float-right",
      style: {
        display: this.props.position === 0 ? '' : 'none'
      },
      onClick: () => this.callCookies(0)
    }, "Pular tour"), /*#__PURE__*/React.createElement("a", {
      className: "btn btn-outline-light btn-outline-light-hover float-right",
      style: {
        display: this.props.position === 1 ? '' : 'none'
      },
      onClick: () => this.callCookies(0)
    }, "Finalizar tour")), /*#__PURE__*/React.createElement("div", {
      className: "box-help-i",
      style: {
        right: this.props.right
      }
    }, /*#__PURE__*/React.createElement("i", {
      className: "fas fa-3x fa-caret-down"
    })));
  }
}