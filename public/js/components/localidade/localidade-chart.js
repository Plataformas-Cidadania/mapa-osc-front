...
var LocalidadeChart = (function (_React$Component) {
    _inherits(LocalidadeChart, _React$Component);

    function LocalidadeChart(props) {
        _classCallCheck(this, LocalidadeChart);

        _get(Object.getPrototypeOf(LocalidadeChart.prototype), "constructor", this).call(this, props);
        this.state = {
            mychart: null,
            data: [],
            loading: false,
