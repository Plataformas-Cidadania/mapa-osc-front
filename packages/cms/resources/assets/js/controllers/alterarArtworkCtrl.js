cmsApp.controller('alterarArtworkCtrl', ['$scope', '$http', 'Upload', '$timeout', function($scope, $http, Upload, $timeout){
    ...
    $scope.alterar = function (file){
        ...
        if(file==null){
            ...
            $http.post("cms/alterar-artwork/"+$scope.id, {'artwork': $scope.artwork, 'removerImagem': $scope.removerImagem}).success(function (data){
                //console.log(data);
                $scope.processandoSalvar = false;
            ...
            file.upload = Upload.upload({
                url: 'cms/alterar-artwork/'+$scope.id,
            ...
            file.upload.then(function (response) {
                ...
                $scope.removerImagem = false;
                $scope.imagemBD = '/imagens/artworks/'+response.data;
    ...
    $scope.carregaImagem  = function(img) {
        if(img!=''){
            $scope.imagemBD = 'imagens/artworks/xs-'+img;
