...
<script>
    ...
    <div ng-controller="linkCtrl">
        <div class="box-padrao">
            ...
            <button class="btn btn-primary" ng-click="mostrarForm=!mostrarForm" ng-show="!mostrarForm">Nova Link</button>
                ...
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        ...
                        <tr ng-repeat="link in links">
                            ...
                            <td><a href="cms/apoio/<% link.id %>"><% link.posicao %></a></td>
                            <td class="text-right">
                                <div>
                                    <a><i class="fa fa-arrow-circle-up fa-2x" title="Posição" ng-click="positionUp(link.id);" style="cursor: pointer;" ng-hide="<% $first %>"></i></a>
