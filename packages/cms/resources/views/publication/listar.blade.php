...
@section('content')
    {!! Html::script(config('app.url').'assets-cms/js/controllers/publicationCtrl.js') !!}
<script>
    $(function () {
    ...
    <div ng-controller="publicationCtrl">
        <div class="box-padrao">
            ...
            <a href="cms/categorias"  class="btn btn-success"  ng-show="!mostrarForm" style="float: right;">Categorias</a>
