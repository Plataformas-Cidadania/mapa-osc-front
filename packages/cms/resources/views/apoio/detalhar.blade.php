...
@section('content')
    ...
    <div ng-controller="alterarApoioCtrl">
        <div class="box-padrao">
            ...
            <?php //print_r($apoio);?>
            <div ng-init="carregaImagem('{{$apoio->imagem}}', '{{$apoio->arquivo}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($apoio, ['name' =>'form']) !!}
                ...
                <a href="arquivos/apoios/<% arquivoBD %>" target="_blank" ng-show="arquivoBD"><% arquivoBD %></a>
                <a ng-show="fileArquivo"><% fileArquivo.name %></a>
                <br><br>

                <br><br>
                @include('cms::apoio._form')
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$apoio->id}}'"/>
                <div class="row">
