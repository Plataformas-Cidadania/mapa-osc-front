...
@section('content')
    {!! Html::script(config('app.url').'assets-cms/js/controllers/postCtrl.js') !!}
<script>
    $(function () {
            ...
            <div class="col-md-12">
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        <thead>
                        <tr>
                            <th ng-click="ordernarPor('id')" style="postr:pointer;">
                                Id
                            ...
                            <th>Imagem</th>
                            <th ng-click="ordernarPor('post')" style="postr:pointer;">
                                Post
                                <i ng-if="ordem=='post' && sentidoOrdem=='asc'" class="fa fa-angle-double-down"></i>
                                <i ng-if="ordem=='post' && sentidoOrdem=='desc'" class="fa fa-angle-double-up"></i>
                            </th>
                            <th></th>
                        </tr>
                        </thead>
                        ...
                        <tr ng-repeat="post in posts">
                            <td><% post.id %></td>
                            <td><img ng-show="post.imagem" ng-src="imagens/posts/xs-<% post.imagem %>" width="60"></td>
                            <td><a href="cms/post/<% post.id %>"><% post.titulo %></a></td>
                            <td class="text-right">
                                <div>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="imagens/posts/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
