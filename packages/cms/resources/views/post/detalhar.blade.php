...
@section('content')
    {!! Html::script(config('app.url').'assets-cms/js/controllers/alterarPostCtrl.js') !!}
    <div ng-controller="alterarPostCtrl">
        <div class="box-padrao">
            <h1><a href="javascript:history.back();"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Posts</h1>
            <?php //print_r($post);?>
            <div ng-init="carregaImagem('{{$post->imagem}}', '{{$post->arquivo}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($post, ['name' =>'form']) !!}
                ...
                <a href="arquivos/posts/<% arquivoBD %>" target="_blank" ng-show="arquivoBD"><% arquivoBD %></a>
                <a ng-show="fileArquivo"><% fileArquivo.name %></a>
                <br><br>

                <br><br>
                @include('cms::post._form')
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$post->id}}'"/>
                <div class="row">
