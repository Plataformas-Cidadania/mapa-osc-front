    ...
    <div ng-controller="alterarEquipeCtrl">
        <div class="box-padrao">
            ...
            <div ng-init="carregaImagem('{{$equipe->imagem}}', '{{$equipe->arquivo}}')">
                ...
                <a href="arquivos/equipes/<% arquivoBD %>" target="_blank" ng-show="arquivoBD"><% arquivoBD %></a>
                ...
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$equipe->id}}'"/>
                <div class="row">
