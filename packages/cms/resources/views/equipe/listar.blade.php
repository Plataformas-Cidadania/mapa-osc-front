...
@section('content')
    {!! Html::script(config('app.url').'assets-cms/js/controllers/equipeCtrl.js') !!}
<script>
    $(function () {
        $('[data-toggle="popover"]').popover()
    })
</script>
    <div ng-controller="equipeCtrl">
        <div class="box-padrao">
            <h1><i class="fa fa-equipe" aria-hidden="true"></i>&nbsp;Equipes</h1>
            <button class="btn btn-primary" ng-click="mostrarForm=!mostrarForm" ng-show="!mostrarForm">Nova Equipe</button>
            ...
            <div class="col-md-12">
                <div class="box-padrao">
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        <thead>
                        <tr>
                            <th ng-click="ordernarPor('id')" style="equiper:pointer;">
                                Id
                            ...
                            <th>Imagem</th>
                            <th ng-click="ordernarPor('equipe')" style="equiper:pointer;">
                                Equipe
                                <i ng-if="ordem=='equipe' && sentidoOrdem=='asc'" class="fa fa-angle-double-down"></i>
                                <i ng-if="ordem=='equipe' && sentidoOrdem=='desc'" class="fa fa-angle-double-up"></i>
                            </th>
                            <th></th>
                        </tr>
                        </thead>
                        ...
                        <tr ng-repeat="equipe in equipes">
                            <td><% equipe.id %></td>
                            <td><img ng-show="equipe.imagem" ng-src="imagens/equipes/xs-<% equipe.imagem %>" width="60"></td>
                            <td><a href="cms/equipe/<% equipe.id %>"><% equipe.titulo %></a></td>
                            <td class="text-right">
                                <div>
                                    {{--<a href="cms/items/<% equipe.id %>"><i class="fa fa-sitemap fa-2x" title="Itens"></i></a>&nbsp;&nbsp;--}}
                                    <a href="cms/equipe/<% equipe.id %>"><i class="fa fa-edit fa-2x" title="Editar"></i></a>&nbsp;&nbsp;
                                    <a><i data-toggle="modal" data-target="#modalExcluir" class="fa fa-remove fa-2x" ng-click="perguntaExcluir(equipe.id, equipe.titulo, equipe.imagem)"></i></a>
                                </div>
                            </td>
                        </tr>
                        </tbody>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="imagens/equipes/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
