...
@section('content')
    ...
    <div ng-controller="alterarTeaserCtrl">
        <div class="box-padrao">
            ...
            <?php //print_r($teaser);?>
            <div ng-init="carregaImagem('{{$teaser->imagem}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($teaser, ['name' =>'form']) !!}
                ...
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$teaser->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile)" ng-disabled="form.$invalid && form.teaser.$dirty">Salvar</button>
                    </div>
