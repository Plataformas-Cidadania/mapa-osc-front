...
@section('content')
    {!! Html::script(config('app.url').'/assets-cms/js/controllers/teaserCtrl.js') !!}
<script>
    $(function () {
        $('[data-toggle="popover"]').popover()
    })
</script>
    <div ng-controller="teaserCtrl">
        <div class="box-padrao">
            <h1><i class="fa fa-fw fa-desktop"></i>&nbsp;Teasers</h1>
            <button class="btn btn-primary" ng-click="mostrarForm=!mostrarForm" ng-show="!mostrarForm">Nova Teaser</button>
            ...
            <div ng-show="mostrarForm">
                ...
                <div class="container-thumb">
                    <div class="box-thumb" name="fileDrop" ngf-dimensions="$width == 600 && $height == 220" ngf-drag-over-class="'box-thumb-hover'" ngf-drop ngf-select ng-model="picFile"
                ...
                <span class="btn btn-primary btn-file" ng-show="!picFile">
                    Escolher imagem <input  type="file" ngf-dimensions="$width == 600 && $height == 220" ngf-select ng-model="picFile" name="file" accept="image/*" ngf-max-size="2MB" ngf-model-invalid="errorFile">
                </span>
            ...
            <div class="col-md-12">
                <div class="box-padrao">
                    <div class="input-group">
                        ...
                        <input class="form-control" type="text" ng-model="dadoTeaser" placeholder="Faça sua busca"/>
                    </div>
                    <br>
                    <div><% mensagemTeaserr %></div>
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        <thead>
                        <tr>
                            <th ng-click="ordernarPor('id')" style="teaserr:pointer;">
                                Id
                            ...
                            <th>Imagem</th>
                            <th ng-click="ordernarPor('teaser')" style="teaserr:pointer;">
                                Teaser
                                <i ng-if="ordem=='teaser' && sentidoOrdem=='asc'" class="fa fa-angle-double-down"></i>
                                <i ng-if="ordem=='teaser' && sentidoOrdem=='desc'" class="fa fa-angle-double-up"></i>
                            </th>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="/imagens/teasers/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% tituloExcluir %></p>
                            </div>
