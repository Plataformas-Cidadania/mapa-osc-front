...
@section('content')
    ...
    <div ng-controller="alterarArtworkCtrl">
        <div class="box-padrao">
            ...
            <?php //print_r($artwork);?>
            <div ng-init="carregaImagem('{{$artwork->imagem}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($artwork, ['name' =>'form']) !!}
                ...
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$artwork->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile)" ng-disabled="form.$invalid && form.artwork.$dirty">Salvar</button>
                    </div>
