...
@section('content')
    {!! Html::script(config('app.url').'assets-cms/js/controllers/noticiaCtrl.js') !!}
<script>
    $(function () {
    ...
    <div ng-controller="noticiaCtrl">
        <div class="box-padrao">
            <h1><i class="fa fa-noticia" aria-hidden="true"></i>&nbsp;Noticias</h1>
                        ...
                        <tr ng-repeat="noticia in noticias">
                            ...
                            <td class="text-right">
                                <div>
                                    ...
                                    <a  ng-class="<% noticia.status %> == 1 ? 'color-success' : 'color-success-inactive'"  style="cursor: pointer;"><i class="fa fa-check-circle fa-2x" aria-hidden="true" ng-click="status(noticia.id);"></i></a>
