...
@section('content')
    {!! Html::script(config('app.url').'assets-cms/js/controllers/alterarLinkCtrl.js') !!}
    <div ng-controller="alterarLinkCtrl">
        <div class="box-padrao">
            <h1><a href="javascript:history.back();"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Links</h1>
            <?php //print_r($link);?>
            <div ng-init="carregaImagem('{{$link->imagem}}', '{{$link->arquivo}}')">
                ...
                <a href="arquivos/links/<% arquivoBD %>" target="_blank" ng-show="arquivoBD"><% arquivoBD %></a>
