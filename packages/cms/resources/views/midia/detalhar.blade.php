...
@section('content')
    ...
    <div ng-controller="alterarMidiaCtrl">
        <div class="box-padrao">
            ...
            <?php //print_r($midia);?>
            <div ng-init="carregaImagem('{{$midia->imagem}}', '{{$midia->arquivo}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($midia, ['name' =>'form']) !!}
                ...
                <a href="arquivos/midias/<% arquivoBD %>" target="_blank" ng-show="arquivoBD"><% arquivoBD %></a>
                <a ng-show="fileArquivo"><% fileArquivo.name %></a>
                {{--<br><br>--}}

                <br><br>
                @include('cms::midia._form')
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$midia->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile, fileArquivo)" ng-disabled="form.$invalid && form.midia.$dirty">Salvar</button>
                    </div>
