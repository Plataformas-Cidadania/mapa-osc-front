...
@section('content')
    {!! Html::script(config('app.url').'assets-cms/js/controllers/alterarEditalCtrl.js') !!}
    <div ng-controller="alterarEditalCtrl">
        <div class="box-padrao">
            <h1><a href="javascript:history.back();"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Editais</h1>
            <?php //print_r($edital);?>
