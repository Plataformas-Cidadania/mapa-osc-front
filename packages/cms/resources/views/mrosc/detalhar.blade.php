    ...
    <div ng-controller="alterarMroscCtrl">
        <div class="box-padrao">
            ...
            <div ng-init="carregaImagem('{{$mrosc->imagem}}', '{{$mrosc->arquivo}}')">
                ...
                <a href="arquivos/mroscs/<% arquivoBD %>" target="_blank" ng-show="arquivoBD"><% arquivoBD %></a>
                <a ng-show="fileArquivo"><% fileArquivo.name %></a>
                <br><br>

                <br><br>
                @include('cms::mrosc._form')
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$mrosc->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile, fileArquivo)" ng-disabled="form.$invalid && form.mrosc.$dirty">Salvar</button>
                    </div>
