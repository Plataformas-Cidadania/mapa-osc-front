...
@section('content')
    {!! Html::script(config('app.url').'assets-cms/js/controllers/alterarPopupCtrl.js') !!}
    <div ng-controller="alterarPopupCtrl">
        <div class="box-padrao">
            <h1><a href="javascript:history.back();"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Popups</h1>
            <?php //print_r($popup);?>
            <div ng-init="carregaImagem('{{$popup->imagem}}', '{{$popup->arquivo}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($popup, ['name' =>'form']) !!}
                ...
                <a href="arquivos/popups/<% arquivoBD %>" target="_blank" ng-show="arquivoBD"><% arquivoBD %></a>
                <a ng-show="fileArquivo"><% fileArquivo.name %></a>
                <br><br>

                <br><br>
                @include('cms::popup._form')
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$popup->id}}'"/>
                <div class="row">
