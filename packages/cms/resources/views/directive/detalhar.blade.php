...
@section('content')
    ...
    <div ng-controller="alterarDirectiveCtrl">
        <div class="box-padrao">
            ...
            <?php //print_r($directive);?>
            <div ng-init="carregaImagem('{{$directive->imagem}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($directive, ['name' =>'form']) !!}
                <div >
                ...
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$directive->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile)" ng-disabled="form.$invalid && form.directive.$dirty">Salvar</button>
                    </div>
