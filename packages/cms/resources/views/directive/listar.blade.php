...
@section('content')
    {!! Html::script(config('app.url').'/assets-cms/js/controllers/directiveCtrl.js') !!}
<script>
    $(function () {
    ...
    <div ng-controller="directiveCtrl">
        <div class="box-padrao">
            <h1><i class="fa fa-fw fa-newspaper-o"></i>&nbsp;Directives</h1>
            <button class="btn btn-primary" ng-click="mostrarForm=!mostrarForm" ng-show="!mostrarForm">Novo Directive</button>
            ...
            <div class="col-md-12">
                <div class="box-padrao">
                    <div class="input-group">
                        ...
                        <input class="form-control" type="text" ng-model="dadoDirective" placeholder="Faça sua busca"/>
                    </div>
                    <br>
                    <div><% mensagemDirectiver %></div>
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        <thead>
                        <tr>
                            <th ng-click="ordernarPor('id')" style="directiver:pointer;">
                                Id
                            ...
                            {{--<th>Imagem</th>--}}
                            <th ng-click="ordernarPor('directive')" style="directiver:pointer;">
                                Directive
                                <i ng-if="ordem=='directive' && sentidoOrdem=='asc'" class="fa fa-angle-double-down"></i>
                                <i ng-if="ordem=='directive' && sentidoOrdem=='desc'" class="fa fa-angle-double-up"></i>
                            </th>
                            <th></th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr ng-repeat="directive in directives">
                            <td><% directive.id %></td>
                            {{--<td><img ng-show="directive.imagem" ng-src="imagens/directives/xs-<% directive.imagem %>" width="60"></td>--}}
                            <td><a href="cms/directive/<% directive.id %>"><% directive.title %></a></td>
                            <td class="text-right">
                                <div>
                                    <a href="cms/directive/<% directive.id %>"><i class="fa fa-edit fa-2x" title="Editar"></i></a>&nbsp;&nbsp;
                                    <a><i data-toggle="modal" data-target="#modalExcluir" class="fa fa-remove fa-2x" ng-click="perguntaExcluir(directive.id, directive.title, directive.imagem)"></i></a>
                                </div>
                            </td>
                        </tr>
                        </tbody>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <img  ng-src="imagens/directives/xs-<% imagemExcluir %>" width="100">
                            </div>
                            <div class="col-md-9">
                                <p><% titleExcluir %></p>
                            </div>
