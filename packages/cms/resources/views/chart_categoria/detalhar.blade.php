...
@section('content')
    {!! Html::script(config('app.url').'assets-cms/js/controllers/alterarChartCategoriaCtrl.js') !!}
    <div ng-controller="alterarChartCategoriaCtrl">
        <div class="box-padrao">
            <h1><a href="javascript:history.back();"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;ChartCategorias</h1>
            <?php //print_r($chartCategoria);?>
            <div ng-init="carregaImagem('{{$chartCategoria->imagem}}', '{{$chartCategoria->arquivo}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($chartCategoria, ['name' =>'form']) !!}
                ...
                <a href="arquivos/chartCategorias/<% arquivoBD %>" target="_blank" ng-show="arquivoBD"><% arquivoBD %></a>
                <a ng-show="fileArquivo"><% fileArquivo.name %></a>
                <br><br>

                <br><br>
                @include('cms::chart_categoria._form')
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$chartCategoria->id}}'"/>
                <div class="row">
