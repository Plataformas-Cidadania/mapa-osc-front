...
@section('content')
    {!! Html::script(config('app.url').'assets-cms/js/controllers/alterarChartCtrl.js') !!}
    <div ng-controller="alterarChartCtrl">
        <div class="box-padrao">
            <h1><a href="../charts"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Chart</h1>
            <?php //print_r($chart);?>
            <div ng-init="carregaImagem('{{$chart->imagem}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($chart, ['name' =>'form']) !!}
                ...
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$chart->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile)" ng-disabled="form.$invalid && form.chart.$dirty">Salvar</button>
                    </div>
