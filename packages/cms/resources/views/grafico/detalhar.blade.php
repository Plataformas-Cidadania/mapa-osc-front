...
@section('content')
    {!! Html::script(config('app.url').'assets-cms/js/controllers/alterarGraficoCtrl.js') !!}
    <div ng-controller="alterarGraficoCtrl">
        <div class="box-padrao">
            <h1><a href="javascript:history.back();"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Graficos</h1>
            <?php //print_r($grafico);?>
            <div ng-init="carregaImagem('{{$grafico->imagem}}', '{{$grafico->arquivo}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($grafico, ['name' =>'form']) !!}
                <div style="display: none;">
                    ...
                    <a href="arquivos/graficos/<% arquivoBD %>" target="_blank" ng-show="arquivoBD"><% arquivoBD %></a>
                ...
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$grafico->id_analise}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile, fileArquivo)" ng-disabled="form.$invalid && form.grafico.$dirty">Salvar</button>
                    </div>
