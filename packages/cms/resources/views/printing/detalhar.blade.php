...
@section('content')
    {!! Html::script(config('app.url').'assets-cms/js/controllers/alterarPrintingCtrl.js') !!}
    <div ng-controller="alterarPrintingCtrl">
        <div class="box-padrao">
            <h1><a href="../printings"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Printings</h1>
            <?php //print_r($printing);?>
            <div ng-init="carregaImagem('{{$printing->imagem}}', '{{$printing->arquivo}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($printing, ['name' =>'form']) !!}
                ...
                <a href="arquivos/printings/<% arquivoBD %>" target="_blank" ng-show="arquivoBD"><% arquivoBD %></a>
                <a ng-show="fileArquivo"><% fileArquivo.name %></a>
                <br><br>

                <br><br>
                @include('cms::printing._form')
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$printing->id}}'"/>
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile, fileArquivo)" ng-disabled="form.$invalid && form.printing.$dirty">Salvar</button>
                    </div>
